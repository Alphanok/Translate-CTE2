...
def compare_files(old_path: Path, new_path: Path):
    """
    Возвращает (changed, added, removed) или None, если файл не удалось распарсить как JSON
    (тогда снаружи можно решить, что делать - например, сравнить как обычный текст).
...
def main():
    ...
    parser.add_argument("-o", "--output", default="report_json.txt", help="Файл отчёта")
